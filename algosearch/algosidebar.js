...
function goToAlgorithms() {
    // Since we're already on the algorithm page, just close the sidebar
    closeSidebar();
...
function goToCipher() {
    // For static site, redirect to cipher page
    window.location.href = '/';
    // Alternative: alert('Redirecting to Cipher Encryption Visualizer...');
}
